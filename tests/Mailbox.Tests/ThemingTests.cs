...
public class ThemeServiceTests
{
    ...
    [InlineData(TokenKeys.RibbonIcon.Outline, TokenKeys.Ribbon.Background)]
    [InlineData(TokenKeys.RibbonIcon.Magenta, TokenKeys.Ribbon.Background)]
    [InlineData(TokenKeys.RibbonIcon.Blue, TokenKeys.Ribbon.Background)]
    [InlineData(TokenKeys.RibbonIcon.Green, TokenKeys.Ribbon.Background)]
